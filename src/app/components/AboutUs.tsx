...
const AboutUs = () => {
  return (
    <section
      id="about"
      className="relative pt-16 pb-15 overflow-hidden bg-gradient-to-br from-indigo-50 via-blue-50/30 to-indigo-50/50"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 max-w-7xl">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto text-lg transition-all duration-300 hover:text-slate-800">
              My journey in quality assurance and commitment to excellence
            </p>
          </div>

          <div className="flex flex-col lg:flex-row gap-6">
            {/* Left Card - Main Content (now slightly smaller) */}
            <div className="lg:w-2/3 order-1">
              <Card className="h-full p-6 md:p-8 bg-white/80 backdrop-blur-xl border border-slate-200/50 shadow-xl shadow-slate-200/50 rounded-2xl hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-500 hover:-translate-y-1">
                <div className="space-y-8">
                  <p className="text-lg leading-relaxed text-slate-700 hover:text-slate-800 transition-colors duration-300">
                    Experienced and passionate Software Quality Assurance
                    Engineer with a solid background in manual testing across
                    mobile, web, and desktop platforms. I bring over 7 years of
                    proven success in ensuring software reliability, user
                    experience, and product performance through strategic QA
                    processes.
                  </p>
                  <p className="text-lg leading-relaxed text-slate-700 hover:text-slate-800 transition-colors duration-300">
                    Specializing in functional, regression, smoke, and sanity
                    testing within agile environments, I&apos;ve contributed to
                    fast-paced teams and cross-functional collaboration efforts
                    to meet tight deadlines and deliver superior digital
                    products. With a strong foundation in API testing, SQL-based
                    validations, and test documentation, I thrive in ensuring
            ...
            {/* Right Card - Enhanced with more content */}
            <div className="lg:w-1/3 order-2">
              <Card className="h-full bg-white/80 backdrop-blur-xl border border-slate-200/50 shadow-xl sm:shadow-2xl shadow-slate-200/50 rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-slate-300/30 transition-shadow duration-300">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {[
                          ...
                          <Badge
                            key={skill}
                            className="bg-blue-50 text-blue-700 border border-blue-200 hover:bg-blue-100 hover:shadow-sm hover:shadow-blue-100 transition-all duration-200 px-3 py-1 text-xs sm:text-sm font-medium"
                          >
                            {skill}
                          </Badge>
                        ))}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {[
                          ...
                          <Badge
                            key={tool}
                            className="bg-indigo-50 text-indigo-700 border border-indigo-200 hover:bg-indigo-100 hover:shadow-sm hover:shadow-indigo-100 transition-all duration-200 px-3 py-1 text-xs sm:text-sm font-medium"
                          >
                            {tool}
                          </Badge>
                        ))}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {[
                          ...
                          <Badge
                            key={domain}
                            className="bg-purple-50 text-purple-700 border border-purple-200 hover:bg-purple-100 hover:shadow-sm hover:shadow-purple-100 transition-all duration-200 px-3 py-1 text-xs sm:text-sm font-medium"
                          >
                            {domain}
                          </Badge>
                        ))}
                    ...
                    {/* <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        {[
                          { name: "Functional", value: "100%" },
                          { name: "Regression", value: "95%" },
                          { name: "UI/UX", value: "90%" },
